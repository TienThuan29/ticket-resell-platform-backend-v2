...
@Component("adminServiceConstantConfiguration")
@PropertySources({
...
public class ConstantConfiguration {
    ...
    public final String STAFF_CODE_PREFIX;
    ...
    public ConstantConfiguration(
            ...
            @Value("${staff.prefix}") String staffPrefix
    ) {
        ...
        this.STAFF_CODE_PREFIX = staffPrefix;
    }
}
